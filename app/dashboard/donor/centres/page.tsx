...
export default async function DonorCentresPage() {
  ...
  return (
    <RoleDashboardShell role="donor">
      <DonorTabPage initialTab="Centre Directory" centres={centres} projects={projects} partners={partners} messages={messages} reports={reports} />
    </RoleDashboardShell>
  );
}
