...
export default async function DonorImpactReportsPage() {
  ...
  return (
    <RoleDashboardShell role="donor">
      <DonorTabPage initialTab="Reports" centres={centres} projects={projects} partners={partners} messages={messages} reports={reports} />
    </RoleDashboardShell>
  );
}
